...
INPUT_PATH = "./inputs"
OUTPUT_PATH = "./output" + iter_changes
...
print("Deleting unused data frames of total size(KB)",
...
if model is None or is_update_model:
    ...
    csv_logger = CSVLogger(os.path.join("", 'training_log_' +
...
# plt.show()
plt.savefig(os.path.join("", 'train_vis_BS_' + str(BATCH_SIZE) + "_" + '.png'))

# load the saved best model from above
saved_model = load_model(os.path.join("", 'best_model.h5'))  # , "lstm_best_7-3-19_12AM",
print(saved_model)
...
plt.show()
plt.savefig(os.path.join("", 'pred_vs_real_BS' + str(BATCH_SIZE) + "_" + '.png'))
